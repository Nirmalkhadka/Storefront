...
import RelatedProductsClient from "@/components/RelatedProductsSection"; // client component
...
export default async function Page({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 min-h-screen">
      ...
      {relatedProducts.length > 0 && <RelatedProductsClient products={relatedProducts} />}
    </div>
  );
}
